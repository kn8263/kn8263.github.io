...
```javascript
// JavaScriptのコードブロック
const example = "Hello,World"; // コメント,コメント横スクロールチェック用。コメント,コメント横スクロールチェック用。もっともっとながく、、、、、、、、ああああああああああああ。"
console.log(example);
```
...
```
プレーンテキストのコードブロックプレーンテキストのコードブロックプレーンテキストのコードブロックプレーンテキストのコードブロックプレーンテキストのコードブロックプレーンテキストのコードブロックプレーンテキストのコードブロック
